...
def pretty_model_name(row: Mapping[str, Any]) -> str:
    ...
    experiment_mapping = {
        ...
        "dpm_v5_cross_domain_sharded_transfer": "DPM-v5 (XD)",
        ...
        "dpm_v5_cross_domain_sharded_transfer_p0_full_eval": "DPM-v5 (XD, P0 full-eval)",
        "dpm_v5_cross_domain_sharded_transfer_p0_full_eval_rob0": "DPM-v5 rob0 (XD, P0 full-eval)",
        # 96x96 P0 full-eval (long-horizon) — configs/cross_domain/*_p0_full_eval_96.yaml
        "dpm_stfm_cross_domain_sharded_transfer_p0_full_eval_96": "DPM-SR (XD, P0 96x96)",
        "dpm_v2_cross_domain_sharded_transfer_p0_full_eval_96": "DPM-v2 (XD, P0 96x96)",
        "dpm_v3_cross_domain_sharded_transfer_p0_full_eval_96": "DPM-v3 (XD, P0 96x96)",
        "dpm_v5_cross_domain_sharded_transfer_p0_full_eval_96": "DPM-v5 (XD, P0 96x96)",
        "dpm_v5_cross_domain_sharded_transfer_p0_full_eval_rob0_96": "DPM-v5 rob0 (XD, P0 96x96)",
        "opencity_cross_domain_sharded_transfer_p0_full_eval_96": "OpenCity (XD, P0 96x96)",
        "factost_cross_domain_sharded_transfer_p0_full_eval_96": "FactoST (XD, P0 96x96)",
        "unist_cross_domain_sharded_transfer_p0_full_eval_96": "UniST (XD, P0 96x96)",
        "dpm_stfm_v4_cross_domain_e2e_transfer_p0_full_eval_96": "DPM-SR v4 (XD E2E, P0 96x96)",
